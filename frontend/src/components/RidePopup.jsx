export default function RidePopup({setRidePopupPanel, setConfirmRidePopupPanel}) {
    ...
    return (
        <div>
            ...
            <div className="flex justify-between flex-col items-center">
                ...
                <button onClick={()=>setConfirmRidePopupPanel(true)} className="w-full bg-green-600 text-white text-xl mt-3 font-semibold p-3 rounded-xl">Accept Ride</button>
